			...
			success:function(json){
				...
				for(var i in cDisponiveis) {
					if(cartoes[cDisponiveis[i]].status == "AVAILABLE") {
						html += '<img onclick="selecionarBandeira(this)" data-bandeira=" '+cartoes[cDisponiveis[i]].name +
                        '" src="https://stc.pagseguro.uol.com.br' + cartoes[cDisponiveis[i]].images.MEDIUM.path + '" border="0" />';
					}
				}
