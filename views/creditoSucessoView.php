        ...
        <div class="panel panel-primary" id="">
            ...
            <div class="panel-body">	
                <?php foreach ($last_debito as $deb): ?>
                    <div class="form-group form-group-sm">
                        <div class="form-group form-group-sm">
                            ...
                            <input type="text" name="data_credito" id="data_credito" class="form-control input-sm" readonly="true" value="<?php echo date("d/m/Y", strtotime($deb['DatMov'])); ?>"/>
                        </div> 
                ...
                <div class="form-group div_button_debito col-sm-12">
                    ...
                    <a class="btn btn-primary" style="height: 35px" href="/conta/creditar/<?php echo $idConta; ?>" title="Novo Pagamento">Novo Crédito</a>
