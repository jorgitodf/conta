...
<aside class="container col-sm-12 col-lg-12">
    <div class="row-fluid col-sm-4 col-lg-4" id="div_row_form_cad_carta_credito">
        <form method="POST" action="" id="form_cadastro_cartao_credito" >
            <div class="panel panel-primary" id="div_panel_form_cad_carta_credito">
                ...
                <div class="panel-body">	
                    ...
                    <div class="row-fluid">
                        <div class="form-group" id="div_botoes_cart_cred">
                        ...
                        <div class="form-group" id="div_msgs_error_cart_cred">
